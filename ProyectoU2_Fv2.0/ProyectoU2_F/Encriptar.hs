...
main1 = do 
 ...
 putStrLn ""
 putStrLn "Ingresa una Clave para encriptar:"
 clave <- getLine 

 putStrLn ""
 putStrLn $ "Archivo original (bytes): " ++ (show (stringAbytes textoOriginal  ))
 ...
 putStrLn ""
 putStrLn $ "Archivo encriptado (bytes): " ++ (show (encriptar (stringAbytes textoOriginal  ) (stringAbytes  clave ) 0 ))

 putStrLn ""
 putStrLn $ "Archivo encriptado (ASCII): " ++ (show (byteAchar (encriptar (stringAbytes textoOriginal  ) (stringAbytes clave ) 0 )))
 
 
 writeFile "archivoEncriptado.txt" ((byteAchar (encriptar (stringAbytes textoOriginal  ) (stringAbytes clave ) 0 )))
...
-- recive una lista x y un entero n
